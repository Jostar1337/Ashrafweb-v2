...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const bioMessages = ["Money is like any other drug. The more you have, the more you need to keep the high.", "\"Owner of Jostar Service!\""];
    let bioMsgIdx = 0;
    ...
    if (viewResultsBtn && skillsBlock) {
        viewResultsBtn.addEventListener('click', () => {
            ...
            if (isHidden) {
                ...
                const skillsData = [
                    { id: "#chatgpt-bar", target: 78 },
                    { id: "#python-bar", target: 12 },
                    { id: "#cpp-bar", target: 28 },
                    { id: "#lua-bar", target: 76 },
                    { id: "#js-bar", target: 99 }
                ];
